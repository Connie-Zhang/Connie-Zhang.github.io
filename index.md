...
{% include button.html text="Github" icon="github" link="https://github.com/Connie-Zhang" color="#0366d6" %}  {% include button text="Email" icon="inbox" mailto:yzhang6@macalester.edu color="#0d94e7" %}
