...
{% include button.html text="Github" icon="github" link="https://github.com/Connie-Zhang" color="#0366d6" %} [{%include button.html text = "Email" icon = "inbox %}](mailto:yzhang6@macalester.edu)
