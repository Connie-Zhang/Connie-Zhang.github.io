...
{% include button.html text="Github" icon="github" link="https://github.com/Connie-Zhang" color="#0366d6" %}  {% class="button" text = "Email" icon = "inbox" href="yzhang6@macalester.edu"%}
